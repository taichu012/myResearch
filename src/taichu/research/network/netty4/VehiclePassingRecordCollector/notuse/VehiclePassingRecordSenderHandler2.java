package taichu.research.network.netty4.VehiclePassingRecordCollector.notuse;
 ...
 * 实现消息的处理
 */
public class VehiclePassingRecordSenderHandler2 extends ChannelInboundHandlerAdapter {

	private static Logger log = Logger.getLogger(VehiclePassingRecordSenderHandler2.class);
...
//    private int MAX_SEND_MSG=1000000; //此基本为极限，2000000导致内存溢出；
     ...
     */
    public VehiclePassingRecordSenderHandler2() {

    }
    
    @Override
    public void channelActive(ChannelHandlerContext ctx) {
    	//非常重要：一般不建议在channelActive中做一次性的发送；
    	//这样做会block住pipeline操作channel流转状态，分发实践，
    	//而且引起内存剧烈增长。类似于水坝积累了发送的bytebuf，一下子放出去一样。
