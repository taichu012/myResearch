package taichu.research.ai.tag.diskview2.demo;
 ...
 * ===========================================================
 *
 * (C) Copyright 2000-2009, by Object Refinery 
 ...
 * ------------------------
 * (C) Copyright 2008, 2009, by Object 
...
DateAxis domainAxis = new DateAxis("Year");
       ...
       ValueAxis rangeAxis = new NumberAxis("$billion");
        XYPlot plot1 = new XYPlot(data1, null, rangeAxis, 
...
int item) {
                ...
                if (dataset.getYValue(series, item) 
...
(Color.white);
      ...
      JFreeChart chart = new JFreeChart("CombinedXYPlotDemo1",
                JFreeChart.DEFAULT_TITLE_FONT, cplot, 
...
chart.addSubtitle(legend);
    ...
    /**
     * Creates a sample dataset.  You wouldn't normally hard-

code the
     * population of a dataset in this way (it would be better to read the
     * values from a file or a database 

query), but for a self-contained demo
...
*/
    private static IntervalXYDataset createDataset1() {
        ...
        // create dataset 1...
        TimeSeries series1 = new 

TimeSeries("Series 1");
        series1.add(new Month(1, 2005), 7627.743);
        series1.add(new Month(2, 2005), 
...
(new Month(12, 2005), 8170.414);
        series1.add(new Month(1, 2006), 8196.070);
        series1.add(new Month(2, 2006), 
...
in this way (it would be better to read the
...
series1 = new TimeSeries("Series 2");
